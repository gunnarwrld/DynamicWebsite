// Step 3A: Fetch and display posts with DummyJSON

// Global state to store data
const appData = {
    posts: [],
    users: {}, // Changed from array to an object for easier lookup by ID
...
// 2. Async function to fetch posts (initial load)
...
// 3. Load more posts when button is clicked
...
// 4. Show/hide Load More button based on available posts
...
// 10. View post detail with comments
...
// 12. View user profile with their posts
async function viewUserProfile(userId) {
    ...
    try {
        ...
        // Display user profile with address
...
async function openUserProfileModal(userId) {
    ...
    try {
        ...
        modalContent.innerHTML = '<div class="error-state">❌ Failed to load profile. Please check your connection and try again.</div>';
    }
}

// 13. Load all posts by a specific user
...
// Setup back buttons and contact form
document.addEventListener('DOMContentLoaded', () => {
